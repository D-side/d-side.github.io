...
Интересно то, что он сделает это самостоятельно. Есть ли аналоги для виртуальных машин и возможны ли вообще? Да, есть.
...
Может ли вложенная система отличить, работает ли она в настоящем окружении, или виртуальном? Может, если против этого не предприняты меры. Зачем это сделано? Чтобы виртуальными машинами было удобнее пользоваться.

Если вы уже попробовали работать с виртуальными машинами, то знаете, что обычно она запускается в собственном окне, в котором эмулируется дисплей, а также в которое передаются все события вашей мыши и клавиатуры (кроме одной клавиши, обычно правого <kbd>Ctrl</kbd>, чтобы вы не остались без управления).
